...
// Parent class for any relation operator classes
class RelationalOp {
	protected:
	pthread_t worker;
...
class RunFunc {
	public:
		// Input arguments for each operator 
		...
		// Working function (i.e., implementation) for each operator
		// The Run() function will spawn the working thread to execute the corresponding function here.
