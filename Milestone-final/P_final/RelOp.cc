...
void RunFunc::SelectFile (void* raw_args) {
	...
	std::cout << "[SelectFile] (To pipe " << args->outPipe << ") The number of records from file '" << args->inFile->m_metaPath << "': " << cnt << std::endl;
...
void RunFunc::SelectPipe (void* raw_args) {
	...
	std::cout << "[SelectPipe] The total number of records from pipe " << args->inPipe << ": " << cnt << ", " << pass << " passed and output to pipe " << args->outPipe << std::endl;
	args->outPipe->ShutDown();
}
...
void RunFunc::Project (void* raw_args) {
	...
	std::cout << "[Project] Input pipe " << args->inPipe << ", output pipe " << args->outPipe << std::endl;
	args->outPipe->ShutDown();
}
...
void RunFunc::Sum (void* raw_args) {
	...
	std::cout << "[Sum] Calculate sum on " << cnt << " records from pipe " << args->inPipe << std::endl;
...
void RunFunc::WriteOut(void* raw_args) {
	...
	std::cout << "---------------------------" << std::endl;
	std::cout << "The number of results: " << cnt << " rows" << std::endl;
}
